/**
 * Голы в скобках — накопительно по сезону ПОСЛЕ текущего матча
 * (включая голы, забитые в этом матче).
 */
...
function attachCumulativeGoalsToMatchList(sortedMatches) {
	...
	for (const match of sortedMatches) {
		...
		// Сначала учитываем голы этого матча в tally → в скобках «после матча»
